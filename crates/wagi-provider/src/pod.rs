...
pub const WAGI_ANNOTATION_KEY_DEFAULT_HOST: &str = "alpha.wagi.krustlet.dev/default-host";
pub const WAGI_ANNOTATION_KEY_MODULES: &str = "alpha.wagi.krustlet.dev/modules";
